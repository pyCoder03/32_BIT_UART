...
void MOD_mkTb::RL_update_cnt()
{
  ...
  DEF_x__h110 = (tUInt8)63u & (DEF_x__h387 + (tUInt8)1u);
  INST_cnt.METH_write(DEF_x__h110);
}

void MOD_mkTb::RL_transmit_uart()
{
  tUInt8 DEF_NOT_cnt_EQ_3_6_AND_cnt_EQ_10_OR_NOT_cnt_EQ_25__ETC___d23;
  tUInt8 DEF_cnt_EQ_3_OR_NOT_cnt_EQ_10_AND_cnt_EQ_25_OR_cnt_ETC___d13;
  tUInt8 DEF_cnt_EQ_10___d7;
  tUInt8 DEF_cnt_EQ_63___d24;
  tUInt8 DEF_cnt_EQ_3___d6;
  tUInt8 DEF_IF_cnt_EQ_3_THEN_0xCA_ELSE_IF_cnt_EQ_25_THEN_0_ETC___d15;
  tUInt8 DEF_cnt_EQ_25___d9;
  DEF_x__h387 = INST_cnt.METH_read();
  DEF_cnt_EQ_25___d9 = DEF_x__h387 == (tUInt8)25u;
  switch (DEF_x__h387) {
  case (tUInt8)3u:
    DEF_IF_cnt_EQ_3_THEN_0xCA_ELSE_IF_cnt_EQ_25_THEN_0_ETC___d15 = (tUInt8)202u;
    break;
  case (tUInt8)25u:
    DEF_IF_cnt_EQ_3_THEN_0xCA_ELSE_IF_cnt_EQ_25_THEN_0_ETC___d15 = (tUInt8)171u;
    break;
  default:
    DEF_IF_cnt_EQ_3_THEN_0xCA_ELSE_IF_cnt_EQ_25_THEN_0_ETC___d15 = (tUInt8)75u;
  }
  DEF_cnt_EQ_3___d6 = DEF_x__h387 == (tUInt8)3u;
  DEF_cnt_EQ_10___d7 = DEF_x__h387 == (tUInt8)10u;
  DEF_cnt_EQ_63___d24 = DEF_x__h387 == (tUInt8)63u;
  DEF_cnt_EQ_3_OR_NOT_cnt_EQ_10_AND_cnt_EQ_25_OR_cnt_ETC___d13 = DEF_cnt_EQ_3___d6 || (!DEF_cnt_EQ_10___d7 && (DEF_cnt_EQ_25___d9 || DEF_x__h387 == (tUInt8)45u));
  DEF_NOT_cnt_EQ_3_6_AND_cnt_EQ_10_OR_NOT_cnt_EQ_25__ETC___d23 = !DEF_cnt_EQ_3___d6 && (DEF_cnt_EQ_10___d7 || (!DEF_cnt_EQ_25___d9 && (DEF_x__h387 == (tUInt8)30u || DEF_x__h387 == (tUInt8)50u)));
  if (DEF_cnt_EQ_3_OR_NOT_cnt_EQ_10_AND_cnt_EQ_25_OR_cnt_ETC___d13)
    INST_uut.METH_par_in(DEF_IF_cnt_EQ_3_THEN_0xCA_ELSE_IF_cnt_EQ_25_THEN_0_ETC___d15);
  if (DEF_NOT_cnt_EQ_3_6_AND_cnt_EQ_10_OR_NOT_cnt_EQ_25__ETC___d23)
    INST_uut.METH_start_tx();
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_cnt_EQ_63___d24)
      dollar_finish(sim_hdl, "32", 1u);
}

void MOD_mkTb::RL_get_output()
{
  tUInt8 DEF_x_uart_tx__h91;
  DEF_x__h387 = INST_cnt.METH_read();
  DEF_x_uart_tx__h91 = INST_uut.METH_uart_tx();
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s,6,1", &__str_literal_1, DEF_x__h387, DEF_x_uart_tx__h91);
}
...
unsigned int MOD_mkTb::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "x__h387", 6u);
...
void MOD_mkTb::vcd_defs(tVCDDumpType dt, MOD_mkTb &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_x__h387, 6u);
